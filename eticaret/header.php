...
<body>
	<div id="wrapper">
		<div class="header"><!--Header EKLENECEKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK -->
			<div class="container">
				<div class="row">
					<div class="col-xs-6 col-md-4 main-logo">
						<a href="index.php"><img width="90" src="<?php echo $ayarcek['ayar_logo'] ?>" alt="Site logosu" class="logo img-responsive"></a>
					</div>
								...
								<div class="regwrap">
									<div class="row">
										<div class="col-md-6 regform">
											...
											<form action="nedmin/netting/islem.php" method="POST" role="form">
												...
												<div class="form-group">
													...
													<label> </label>
													<button type="submit" name="sifremiunuttum" class="btn btn-default btn-red btn-sm">Şifremi Unuttum</button>
												</div>
										...
										<div class="col-md-6">
											...
											<p>
												Hızlı ve güvenli alışveriş yapmak için bir hesap açın, Böylece siparişinizin durumunu takip edin..
											</p>
											<a href="register"><button class="btn btn-default btn-yellow">Şimdi Üye Ol</button></a>
										</div>
									</div>
								</div>
								<div class="srch-wrap">
			...
			<div class=""></div> <!-- dashed EKLENECEKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK -->
		</div class="deshed"><!--Header -->
