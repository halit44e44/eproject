	...
	<form action="nedmin/netting/islem.php" method="POST" class="form-horizontal checkout" role="form">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<center><a href="sifre-guncelle.php"><img width="400" src="https://www.ersag.web.tr/wp-content/uploads/2019/04/ersag-uye-numarami-%C5%9Fifremi-unuttum-728x410.jpg"></center></a>
			</div>
		</div>
	</div>
</form>
