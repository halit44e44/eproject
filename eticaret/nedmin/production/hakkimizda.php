            ...
            <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" value="<?php echo $hakkimizdacek['hakkimizda_baslik'] ?>" name="hakkimizda_baslik" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>

                        <!-- 
                          
                          BU KISMA HAKKIMIZDA YERİ GELİNECEK 
                          ALTTAKİ İÇERİK KISMI DEĞİŞECEK
                          BÖLÜM SONU KODLARINDAN ALINACAK
                          -----
                          -----
                          ----
                          ALTTAKİ İÇERİK KISMIDA SİLİNECEK..
                        -->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" value="<?php echo $hakkimizdacek['hakkimizda_video'] ?>" name="hakkimizda_video" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" value="<?php echo $hakkimizdacek['hakkimizda_vizyon'] ?>" name="hakkimizda_vizyon" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" value="<?php echo $hakkimizdacek['hakkimizda_misyon'] ?>" name="hakkimizda_misyon" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
