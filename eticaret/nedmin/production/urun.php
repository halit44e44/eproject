      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            ...
            <div class="clearfix"></div>
            <div align="right">
              <a href="urun-ekle.php"><button class="btn btn-success btc xs">Yeni Ürün</button></a>
            </div>
          </div>
              ...
              <tbody>
                ...
                while($uruncek=$urunsor->fetch(PDO::FETCH_ASSOC)) { 
                  ...
                  <tr>
                    ...
                    <td><a href="urun-galeri.php?urun_id=<?php echo $uruncek['urun_id'] ?>"><center><button  class="btn btn-success btn-xs">Resim İşlemleri</button></center></a></td>
                    ...
                    <th>
                      ...
                      if ($uruncek['urun_onecikar']==1) {?>
                        ...
                        <center><button class="btn btn-success btn-xs">Öne Çıkmış</button></center>


                      <?php }  else { ?>
                        <center><button class="btn btn-danger btn-xs">Öne Çıkmamış</button></center>
